          ...
          <div>
            <form name="form">
              <FormGroup className="mb-5">
                ...
                />
                <FormControl.Feedback className={!status.address ? 'd-block' : ''} type="invalid">
                  {status.msg}
                </FormControl.Feedback>
              </FormGroup>
              <div className="row m-0">
                <p className="mb-2">
                  <Link className="color-blue" to={Routes.CreateWallet.path}>
                    Click here
                  </Link>{' '}
                  to create your crypto wallet
                </p>
              </div>
              <FormGroup className="w-100">
                <Button
                  className="bg-blue color-white form-control"
                  type="default"
                  onClick={handleLink}
                >
                  Next
        ...
        <>
          ...
          <div>
            <form name="form">
              ...
              <FormGroup className="w-100">
                <Button className="bg-white color-blue form-control" onClick={handleNext('skip')}>
                  Skip for now
                </Button>
              </FormGroup>
            </form>
