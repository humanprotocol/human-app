              ...
              <div>
                <form name="form">
                  <FormGroup className="mb-5">
                    <FormControl placeholder="Wallet address" type="text" value={address} onChange={handleChange} />
                  ...
                  <div className="row m-0">
                    <p className="mb-2">
                      <Link className="color-blue" to={Routes.CreateWallet.path}>Click here</Link>
                      {' '}
