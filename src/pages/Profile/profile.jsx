...
import {
  FormGroup, FormControl, Button, Dropdown, Alert,
        ...
        <div>
          <form name="form" className="m-0">
            <FormGroup>
              ...
              && (
              <>
                <FormControl placeholder="Full Name" type="text" name="name" value={inputs.name} onChange={handleChange} readOnly={!editing} />
            ...
            <FormGroup>
              ...
              && (
              <>
                <FormControl placeholder="Email" type="email" name="email" value={inputs.email} onChange={handleChange} readOnly />
            ...
            <FormGroup>
              ...
              { editing
                && (
                <>
                  <FormControl placeholder="Wallet address" type="text" name="walletAddress" value={inputs.walletAddress} onChange={handleChange} readOnly={!editing} />
