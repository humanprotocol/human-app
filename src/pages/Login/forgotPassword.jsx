          ...
          <form name='form' onSubmit={handleSubmit}>
            ...
            <>
              <FormGroup className='password'>
                <Password onChange={handleChange} name='password' value={password} placeholder='Create password' className='mb-5'></Password>
                {validationErrors.password &&
                <FormControl.Feedback type='invalid' className='d-block'>{validationErrors.password}</FormControl.Feedback>
                }
              </FormGroup>
              <FormGroup className='password'>
                <Password onChange={handleChange} name='repeatPassword' value={repeatPassword} placeholder='Confirm password' className='mb-5'></Password>
