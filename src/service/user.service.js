...
export const register = async (user) => {
  ...
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/auth/register`, { ...user })
    .then((response) => {
      if (response) {
...
export const signIn = async ({ email, password, hcaptchaToken }) => {
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/auth/login`, {
      email,
      password,
      hcaptchaToken,
    })
...
export const update = async (id, token, user) =>
  axios
    .patch(`${window._env_.REACT_APP_API_URL}/v1/users/${id}`, user, {
      headers: {
...
export const logOut = async (token, refreshToken) =>
  axios
    .post(
      `${window._env_.REACT_APP_API_URL}/v1/auth/logout`,
      { refreshToken },
...
export const forgotPassword = async (email) => {
  ...
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/auth/forgot-password`, { email })
    .catch((err) => {
      if (err.response) throw new Error(err.response.data.message);
      else throw new Error('Network Error');
    });
...
export const resetPassword = async (password, token) => {
  ...
  return axios
    .post(
      `${window._env_.REACT_APP_API_URL}/v1/auth/reset-password`,
      { password },
      { params: { token } },
    )
    .catch((err) => {
...
export const getMyAccount = async (id, token) =>
  axios
    .get(`${window._env_.REACT_APP_API_URL}/v1/users/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    })
    .then((response) => {
...
export const verifyEmail = async (token) =>
  axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/auth/verify-email`, null, { params: { token } })
    .then((response) => {
      if (response && response.status === 204) {
        return true;
      }
...
export const sendNewsletterSignup = async (data) =>
  axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/auth/register-interest`, data)
    .then((response) => {
      if (response && response.status === 204) {
        return true;
      }
...
export const resendEmailVerification = async (token) =>
  axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/auth/send-verification-email`, null, {
      headers: { Authorization: `Bearer ${token}` },
    })
    .then((response) => {
      if (response && response.status === 204) {
...
export const setQuestionnaire = async (
  ...
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/users/${id}/misc`, body, headers)
...
export const postVeriffSessionId = async ({ veriffUserId, token }) => {
  ...
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/users/kyc/started`, body, headers)
    .then((response) => response?.data)
    .catch((err) => {
      throw new Error(err.response.data.message);
    });
...
export const suspendUsers = async (userEmails, suspendStatus, authToken) => {
  ...
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/users/suspend`, body, options)
    .then((response) => {
      if (response) {
        return {
...
export const unsuspendUsers = async (userEmails, authToken) => {
  ...
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/users/unsuspend`, body, options)
    .then((response) => {
...
export const deleteUsersByEmail = async (userEmails, authToken) => {
  ...
  return axios
    .post(`${window._env_.REACT_APP_API_URL}/v1/users/delete/emails`, body, options)
    .then((response) => {
      if (response && response.status === 200) {
        return {
