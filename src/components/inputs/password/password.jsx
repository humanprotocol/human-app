    ...
    return (
        <div className="form-group password">
            <div className="input-group">
                <FormControl placeholder={props.placeholder} type={hidden
? 'password'
: 'text'} name={props.name} value={props.value} onChange={props.onChange}></FormControl>
                <span onClick={ToogleShow} className="position-absolute d-flex flex-column justify-content-center h-100"><i className={`fa ${hidden
? 'fa-eye-slash'
