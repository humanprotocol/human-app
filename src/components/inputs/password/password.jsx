    ...
    return (
        <div className='form-group password'>
            <div className='input-group'>
                ...
                <span onClick={ToogleShow} className='position-absolute d-flex flex-column justify-content-center h-100'><i className="fa fa-eye-slash" aria-hidden="true"></i></span>
            </div>
