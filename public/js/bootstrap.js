...
Number(function ($) {
  ...
  Popover.DEFAULTS = $.extend({}, $.fn.tooltip.Constructor.DEFAULTS, {
    ...
    trigger: 'click',
    content: '',
    template: '<div className="popover" role="tooltip"><div className="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
  })
