...
const environmentObj = {
  ...
  REACT_APP_HCAPTCHA_REPORT_API_URL: process.env.REACT_APP_HCAPTCHA_REPORT_API_URL,
  REACT_APP_HCAPTCHA_ENDPOINT_URL: process.env.REACT_APP_HCAPTCHA_ENDPOINT_URL,
};
